...
export const mockAgentStatus: AgentStatus[] = [
  { name: 'Intake', status: 'success', success_rate: '10/10', avg_latency: '0.8s' },
...
[Your name]`,
  ...
  est_tokens: 3420,
  trace: [
    { agent: 'Intake', status: 'success', input_summary: 'Raw CSV row — NovaBridge Solutions', output_summary: 'Clean lead object. All required fields present. No validation warnings.', latency: '0.7s', tokens: 280, prompt_version: 'v1.2' },
    { agent: 'Research', status: 'success', input_summary: 'Validated lead — NovaBridge Solutions, B2B SaaS, USA', output_summary: '4 evidence cards generated. 3 high-confidence signals. 1 medium. No invented sources.', latency: '4.1s', tokens: 890, prompt_version: 'v1.3' },
