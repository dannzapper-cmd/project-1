...
## 5.3 Estrategia correcta: cosechas mensuales de contexto

Las llamadas se usarán como **sesiones de cosecha de alto valor**, sobre selecciones previamente preparadas y consolidadas.
...
## 5.4 Plan sugerido para seis llamadas
...
### Llamada 6 · Flujo aprobado o auditoría
...
La distribución puede cambiar por prioridad. No gastar llamadas para “explorar” sin preparar.
...
```text
docs/design/figma-harvest/raw/YYYY-MM/
├── call_01_prompt.md
